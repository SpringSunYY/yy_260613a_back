...
public class CodegenColumnSaveReqVO {
    ...
    @I18nNotNull(i18nKey = "infra.codegenColumn.back.tableId.notNull", message = "表编号不能为空")
    private Long tableId;

    @Schema(description = "字段名", requiredMode = Schema.RequiredMode.REQUIRED, example = "user_age")
    @I18nNotNull(i18nKey = "infra.codegenColumn.back.columnName.notNull", message = "字段名不能为空")
    private String columnName;

    @Schema(description = "字段类型", requiredMode = Schema.RequiredMode.REQUIRED, example = "int(11)")
    @I18nNotNull(i18nKey = "infra.codegenColumn.back.dataType.notNull", message = "字段类型不能为空")
    private String dataType;

    @Schema(description = "字段描述", requiredMode = Schema.RequiredMode.REQUIRED, example = "年龄")
    @I18nNotNull(i18nKey = "infra.codegenColumn.back.columnComment.notNull", message = "字段描述不能为空")
    private String columnComment;

    @Schema(description = "是否允许为空", requiredMode = Schema.RequiredMode.REQUIRED, example = "true")
    @I18nNotNull(i18nKey = "infra.codegenColumn.back.nullable.notNull", message = "是否允许为空不能为空")
    private Boolean nullable;

    @Schema(description = "是否主键", requiredMode = Schema.RequiredMode.REQUIRED, example = "false")
    @I18nNotNull(i18nKey = "infra.codegenColumn.back.primaryKey.notNull", message = "是否主键不能为空")
    private Boolean primaryKey;

    @Schema(description = "排序", requiredMode = Schema.RequiredMode.REQUIRED, example = "10")
    @I18nNotNull(i18nKey = "infra.codegenColumn.back.ordinalPosition.notNull", message = "排序不能为空")
    private Integer ordinalPosition;

    @Schema(description = "Java 属性类型", requiredMode = Schema.RequiredMode.REQUIRED, example = "userAge")
    @I18nNotNull(i18nKey = "infra.codegenColumn.back.javaType.notNull", message = "Java 属性类型不能为空")
    private String javaType;

    @Schema(description = "Java 属性名", requiredMode = Schema.RequiredMode.REQUIRED, example = "Integer")
    @I18nNotNull(i18nKey = "infra.codegenColumn.back.javaField.notNull", message = "Java 属性名不能为空")
    ...
    @I18nNotNull(i18nKey = "infra.codegenColumn.back.createOperation.notNull", message = "是否为 Create 创建操作的字段不能为空")
    private Boolean createOperation;

    @Schema(description = "是否为 Update 更新操作的字段", requiredMode = Schema.RequiredMode.REQUIRED, example = "false")
    @I18nNotNull(i18nKey = "infra.codegenColumn.back.updateOperation.notNull", message = "是否为 Update 更新操作的字段不能为空")
    private Boolean updateOperation;

    @Schema(description = "是否为排序字段", requiredMode = Schema.RequiredMode.REQUIRED, example = "true")
    @I18nNotNull(i18nKey = "infra.codegenColumn.back.sortOperation.notNull", message = "是否为排序字段不能为空")
    private Boolean sortOperation;

    @Schema(description = "是否为 List 查询操作的字段", requiredMode = Schema.RequiredMode.REQUIRED, example = "true")
    @I18nNotNull(i18nKey = "infra.codegenColumn.back.listOperation.notNull", message = "是否为 List 查询操作的字段不能为空")
    ...
    @I18nNotNull(i18nKey = "infra.codegenColumn.back.listOperationCondition.notNull", message = "List 查询操作的条件类型不能为空")
    private String listOperationCondition;

    @Schema(description = "是否为 List 查询操作的返回字段", requiredMode = Schema.RequiredMode.REQUIRED, example = "true")
    @I18nNotNull(i18nKey = "infra.codegenColumn.back.listOperationResult.notNull", message = "是否为 List 查询操作的返回字段不能为空")
    private Boolean listOperationResult;

    @Schema(description = "显示类型", requiredMode = Schema.RequiredMode.REQUIRED, example = "input")
    @I18nNotNull(i18nKey = "infra.codegenColumn.back.htmlType.notNull", message = "显示类型不能为空")
