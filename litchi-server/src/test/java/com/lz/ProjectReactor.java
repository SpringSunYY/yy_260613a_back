...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.lz.litchi";
    private static final String ARTIFACT_ID = "litchi";
    private static final String PACKAGE_NAME = "com.lz";
    private static final String TITLE = "荔枝软件开发";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.lz.litchi";
        String artifactIdNew = "litchi";
        String packageNameNew = "com.lz";
        String titleNew = "荔枝软件开发";
