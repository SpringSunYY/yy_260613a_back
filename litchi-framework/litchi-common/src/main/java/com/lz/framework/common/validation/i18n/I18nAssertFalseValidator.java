...
/**
 * I18nAssertFalse 注解的校验器
 */
public class I18nAssertFalseValidator implements ConstraintValidator<I18nAssertFalse, Boolean> {

    private String i18nKey;
    private String defaultMessage;

    @Override
    public void initialize(I18nAssertFalse constraintAnnotation) {
