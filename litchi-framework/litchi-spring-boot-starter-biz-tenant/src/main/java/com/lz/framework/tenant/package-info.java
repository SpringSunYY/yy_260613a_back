 ...
 *      1）Spring Async：
 *          {@link com.lz.framework.quartz.config.LitchiAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 LitchiSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
