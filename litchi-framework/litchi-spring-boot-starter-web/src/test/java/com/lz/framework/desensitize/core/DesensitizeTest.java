...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("荔枝源码");
        ...
        desensitizeDemo.setRegex("你好，我是荔枝源码");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("荔枝源码");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "荔枝源码", replacer = "*")
